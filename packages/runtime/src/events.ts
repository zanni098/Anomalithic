...
type EventOfType<T extends RuntimeEventType> = ExtractByType<RuntimeEvent, T>
type ExtractByType<E, T> = E extends { type: T } ? E : never
...
export class EventBus {
  ...
  on<T extends RuntimeEventType>(type: T, fn: (event: EventOfType<T>) => void): () => void {
