 ...
 * provider round-trip). This is the unit the ad layer (later phase) will redeem:
 * impressions can only be minted by the runtime, never spoofed by a client timer.
 *
 * Ported verbatim from the pre-rebuild `@anomalithic/core` (the proven ad trust
 * anchor). See docs/specs/thinking-impressions.md.
 */
